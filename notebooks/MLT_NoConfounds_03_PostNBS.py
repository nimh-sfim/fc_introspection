...
data_f1GTf2 = np.loadtxt('/data/SFIMJGC_Introspec/2023_fc_introspection/code/fc_introspection/resources/mtl_snycq/no_confounds/nbs/{ATLAS_NAME}/NBS_{s}_Results/NBS_{s}_F1gtF2.edge'.format(s=SOLUTION, ATLAS_NAME=ATLAS_NAME))
...
data_f2GTf1 = np.loadtxt('/data/SFIMJGC_Introspec/2023_fc_introspection/code/fc_introspection/resources/mtl_snycq/no_confounds/nbs/{ATLAS_NAME}/NBS_{s}_Results/NBS_{s}_F2gtF1.edge'.format(s=SOLUTION, ATLAS_NAME=ATLAS_NAME))
...
hvplot_fc(data_f2GTf1,ATLASINFO_PATH, cbar_title='F2 > F1')
...
hvplot_fc_nwlevel(data_f2GTf1, title='F2 > F1', add_net_colors=True)
...
hvplot_fc_nwlevel(data_f2GTf1, mode='count', title='F2 > F1')
...
plot_as_circos(data_f2GTf1, roi_info, edge_weight=.5, figsize=(7,7))
