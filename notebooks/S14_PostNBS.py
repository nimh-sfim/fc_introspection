...
from utils.plotting import hvplot_fc, plot_fc, hvplot_fc_nwlevel
...
data_f1GTf2 = pd.DataFrame(data_f1GTf2,
                           index   = roi_info.set_index(['Hemisphere','Network','ROI_Name']).index, 
                           columns = roi_info.set_index(['Hemisphere','Network','ROI_Name']).index)
