...
from utils.basics import PRJ_DIR, SCRIPTS_DIR, RESOURCES_CPM_DIR, DATA_DIR, FB_400ROI_ATLAS_NAME, FB_200ROI_ATLAS_NAME
...
E_SUMMARY_METRIC     = 'ridge'           # How to summarize across selected edges on the final model
