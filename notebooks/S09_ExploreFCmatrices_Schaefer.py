...
ATLASINFO_PATH = osp.join(ATLASES_DIR,CORTICAL_ATLAS_NAME,'{ATLAS_NAME}_order_FSLMNI152_2mm.ranked.roi_info.csv'.format(ATLAS_NAME=CORTICAL_ATLAS_NAME))
...
for sbj,run in tqdm(scan_list):
    ...
    netcc_path = osp.join(DATA_DIR,'PrcsData',sbj,'preprocessed','func','pb06_staticFC','{run_acq}_run-{run_num}.{ATLAS_NAME}_000.netcc'.format(run_acq = run_acq, run_num = run_num, ATLAS_NAME = CORTICAL_ATLAS_NAME))
