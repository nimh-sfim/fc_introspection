...
print("++INFO: importing nilearn masking")
from nilearn import masking
print("++INFO: successfully imported nilearn masking")
...
print('++ INFO: Resources Nimae Folder %s' % RESOURCES_NIMARE_DIR)
def run(args):
  ...
  if do_full_setup:
      ...
      for folder_path in [RESOURCES_NIMARE_DIR, VOCAB_DIR, METAMAPS_ORIG_DIR] :
...
def main():
  ...
  print("++ INFO: Program configuration...")
  print(args)
  print("++ INFO: Map Generation starts now...")
  args.func(args)
